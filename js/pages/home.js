    ...
    const html = `
        <section class="hero" id="about">
            <div class="hero__orbit-decoration" aria-hidden="true">
                <img src="assets/imgs/Logo transparent/Asset 1.png" alt="" loading="eager" width="500" height="500">
            </div>
            <div class="hero__container">
                ...
                <div class="hero__meta">
                    <span class="hero__meta-tag">Events</span>
        ...
        <section class="network" id="network">
            <div class="section-container network__section-inner">
                <img src="assets/imgs/Logo transparent/Asset 17.png" alt="" class="network__orbit-accent" aria-hidden="true" loading="lazy" width="200" height="140">
